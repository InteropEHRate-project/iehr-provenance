 ...
 *
 *  Description: Node implementation for a FHIR Resource of type DiagnosticReport
 */
	...
	public void loadChildren(ResourceNode root) {
        ...
        for (Reference ref : resRefs) {
        	...
        	if (currentResource == null) {
        		logger.warn("Found a reference pointing to a null resource: " + ref.getReference());
        		continue;
        	}
