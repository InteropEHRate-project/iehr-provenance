...
public class UnsuccessfullValidation {
	...
	public static void main(String[] args) throws Exception {
		Logger logger = LoggerFactory.getLogger(UnsuccessfullValidation.class);
		 ...
		 */
		InputStream is = UnsuccessfullValidation.class.getClassLoader().getResourceAsStream("BundleToSign1.json");
        ...
        // #5 **** Adds an Observation without Provenance to the Bundle
		...
		value.setValue(80.9).setSystem("http://unitsofmeasure.org").setCode("kg");
		observation.setValue(value);
		bundle.addEntry().setResource(observation);
		
        // **** Only for DEBUG purposes!!
		bundleTree = NodeFactory.createNode(bundle);
        bundleTree.loadChildren(bundleTree);
        bundleTree.print4Debug();
        // **** Only for DEBUG purposes!!
